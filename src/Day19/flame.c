...
static int g_is_chrooted = 0;

static char g_program_path[PATH_MAX] = {0};
static char *g_argv_copy[128] = {0};
...
static int sanitize_path(const char *input, char *output, size_t outlen) {
    size_t i = 0, j = 0;
...
static void master_start_log_server(void) {
